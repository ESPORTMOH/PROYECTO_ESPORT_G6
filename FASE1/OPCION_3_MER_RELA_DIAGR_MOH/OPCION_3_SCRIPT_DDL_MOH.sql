...
--   fecha: 2018-04-19 20:29:08 CEST
...
ALTER TABLE ADMINISTRADOR ADD CONSTRAINT ADMINISTRADOR_PK PRIMARY KEY ( COD_PERSONA ) ;
...
CREATE TABLE DUENO
  (
    ...
    EQUIPO_COD_EQUIPO NUMBER (16) NOT NULL
  ) ;
...
CREATE TABLE EQUIPO
  (
    ...
    PARTIDO_COD_PARTIDO  NUMBER (50) NOT NULL ,
    PARTIDO_COD_PARTIDO1 NUMBER (50) NOT NULL
  ) ;
...
CREATE TABLE JUGADOR
  (
    COD_JUGADOR       NUMBER (50) NOT NULL ,
    NOMBRE            VARCHAR2 (20) NOT NULL ,
...
CREATE TABLE PARTIDO
  (
    COD_PARTIDO         NUMBER (50) NOT NULL ,
    FECHA               DATE NOT NULL ,
    HORA                DATE NOT NULL ,
    PUNTOS_LOCAL        NUMBER (3) NOT NULL ,
    PUNTOS_VISITANTE    NUMBER (3) NOT NULL ,
    EQUIPO_COD_EQUIPO   NUMBER (16) NOT NULL ,
    EQUIPO_COD_EQUIPO1  NUMBER (16) NOT NULL ,
...
ALTER TABLE ADMINISTRADOR ADD CONSTRAINT ADMINISTRADOR_PERSONA_FK FOREIGN KEY ( COD_PERSONA ) REFERENCES PERSONA ( COD_PERSONA ) ;
