...
public class VPanelCrudJornadas extends javax.swing.JFrame {
    ...
    /**
     * Creates new form VPanelCrudJornada
     */
    public VPanelCrudJornadas() {
        this.tipoVentana = "VCrudJornadas";
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("GESTION DEL CALENDARIO");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VPanelCrudJornadas().setVisible(true);
            }
        });
    }
