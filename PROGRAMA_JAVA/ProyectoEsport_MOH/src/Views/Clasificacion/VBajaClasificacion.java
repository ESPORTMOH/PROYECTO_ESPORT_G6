...
public class VBajaClasificacion extends javax.swing.JFrame {
    ...
    /**
     * Creates new form VBajaClasificacion
     */
    public VBajaClasificacion() {
        initComponents();
        this.tipoVentana = "VBajaClasificacion";
    ...
    private void initComponents() {
        ...
        jLabel1.setText("ELIMINAR CLASIFICACIÓN");
    ...
    private void jBbajaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBbajaActionPerformed
        ...
        if (preguntaSalida == JOptionPane.YES_OPTION) {
            try {
                ...
                Logger.getLogger(VBajaClasificacion.class.getName()).log(Level.SEVERE, null, EX);
            }
        }
    }//GEN-LAST:event_jBbajaActionPerformed

    private void jBconsultarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBconsultarActionPerformed
        // ACTION PARA BUSCAR CLASIFICACION PRIMERO EN LA BD Y ELIMINAR DESPUES SI SE QUIERE
        try {
            if (jTnumTemporada.getText().isEmpty()) {
                throw new CampoNumTemporadaVacio();
            } else {
                Controladora.localizarClasificacionEnBD();
            }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VBajaClasificacion.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VBajaClasificacion().setVisible(true);
            }
        });
    }
