...
public class VPanelClasificacion extends javax.swing.JFrame {
    ...
    /**
     * Creates new form VPanelClasificacion
     */
    public VPanelClasificacion() {
        this.tipoVentana = "VPanelClasificacion";
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("GESTIÓN DE CLASIFICACIONES");
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Img/clasi.png"))); // NOI18N
    ...
    private void jBaltaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBaltaActionPerformed
        // ACTION ALTA
        try {
            Controladora.abrirAltaClasificacion();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VPanelClasificacion.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
