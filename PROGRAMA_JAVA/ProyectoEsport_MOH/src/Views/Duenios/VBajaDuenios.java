...
public class VBajaDuenios extends javax.swing.JFrame {
    ...
    private void jBconsultarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBconsultarActionPerformed
        // ACTION PARA BUSCAR DUEÑO PRIMERO EN LA BD Y ELIMINAR DESPUES SI SE QUIERE
        try {
    ...
    private void jBbajaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBbajaActionPerformed
        ...
        if (preguntaSalida == JOptionPane.YES_OPTION) {
            try {
                ...
                Logger.getLogger(VBajaDuenios.class.getName()).log(Level.SEVERE, null, EX);
            }
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VBajaDuenios.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VBajaDuenios().setVisible(true);
            }
        });
    }
