...
INSERT INTO jugador (codJugador, dni, nombre, apellido, nickname, sueldo, fechaNacimiento, nacionalidad, posicion) VALUES (DEFAULT, '12345678A', 'nombre', 'apellido', 'nickname', 150000, to_date('10/10/1000', 'dd/mm/YYYY'), 'nacionalidad', 'j')
...
select * from jugador;
            ...
            SELECT sum(sueldo)
            FROM jugador;
delete from jugador where codJugador = 7;
truncate jugador;
rollback
-- --------------------------------------------------------
